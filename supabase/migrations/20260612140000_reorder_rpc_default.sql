-- p_dept_id default null: codegen генерит параметр опциональным,
-- ручные правки supabase/types.ts больше не нужны.
drop function if exists reorder_employees(uuid, uuid[]);

create or replace function reorder_employees(p_ordered_ids uuid[], p_dept_id uuid default null)
returns void
language plpgsql
security invoker
