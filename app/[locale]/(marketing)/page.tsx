...
export default async function LandingPage({
  ...
  const gridLabels: GridPreviewLabels = {
    ...
    scheduleTab: tg('scheduleTab'),
    employeesTab: tg('employeesTab'),
    employeeViewCards: tg('employeeViewCards'),
    employeeViewList: tg('employeeViewList'),
    employeePhone: tg('employeePhone'),
    employeeContactInfo: tg('employeeContactInfo'),
    employeeTelegram: tg('employeeTelegram'),
    employeeEmail: tg('employeeEmail'),
    employeeProject: tg('employeeProject'),
    employeeBirthday: tg('employeeBirthday'),
    employeeBirthdayIn: tg.raw('employeeBirthdayIn'),
    employeeAgeYears: tg.raw('employeeAgeYears'),
    employeeCompanyDays: tg('employeeCompanyDays'),
    employeeCompanyDaysValue: tg.raw('employeeCompanyDaysValue'),
    employeeAgeYearsOne: tg.raw('employeeAgeYearsOne'),
    employeeAgeYearsFew: tg.raw('employeeAgeYearsFew'),
    employeeCompanyDaysOne: tg.raw('employeeCompanyDaysOne'),
    employeeCompanyDaysFew: tg.raw('employeeCompanyDaysFew'),
    employeeActive: tg('employeeActive'),
    employeeLock: tg('employeeLock'),
    ariaPrevMonth: tg('ariaPrevMonth'),
    ariaNextMonth: tg('ariaNextMonth'),
    ariaTimerStart: tg('ariaTimerStart'),
    ariaTimerPause: tg('ariaTimerPause'),
    ariaNotifications: tg('ariaNotifications'),
    ariaUserMenu: tg('ariaUserMenu'),
    ariaMore: tg('ariaMore'),
    localeTag: locale,
    employeeTrainee: tg('employeeTrainee'),
    employeeStaff: tg('employeeStaff'),
    days: {
    ...
    assignmentTitle: tg('assignmentTitle'),
    assignmentSubtitle: tg('assignmentSubtitle'),
    assignmentStructureLabel: tg('assignmentStructureLabel'),
    assignmentBranchLabel: tg('assignmentBranchLabel'),
    assignmentAddRole: tg('assignmentAddRole'),
    assignmentAddDepartment: tg('assignmentAddDepartment'),
    assignmentRolePlaceholder: tg('assignmentRolePlaceholder'),
    assignmentDepartmentPlaceholder: tg('assignmentDepartmentPlaceholder'),
    assignmentRoleCount: tg.raw('assignmentRoleCount'),
    assignmentNoRoles: tg('assignmentNoRoles'),
    saveBtn: tg('saveBtn'),
    customBadge: tg('customBadge'),
    resetBtn: tg('resetBtn'),
    showRolesLabel: tg('showRolesLabel'),
    showEmployeeRoleLabel: tg('showEmployeeRoleLabel'),
    showEmployeeDepartmentLabel: tg('showEmployeeDepartmentLabel'),
    showEmployeeDotLabel: tg('showEmployeeDotLabel'),
